        ...
        <section class="birthday-event  my-5 pb-md-3">
          ...
          <div class=" d_md_none ">
                        <div class="ml-3">
                         ...
                         <p class="order-summary fw-600 fs-18 align-self-center text-center w-100">PARTY TIME</p>
          </div>
         <p class="order-summary fw-600 fs-18 d_sm_none">PARTY TIME</p>
           <?= $output?>
          </div>
        </section>
        <section class="partytime_event">
              <?=$output1?>
        </section>
              <!-- <span class="stop_fixed" style="margin-top: 50px"></span> -->
